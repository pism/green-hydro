    ...
    for K in 1e18; do
        for THK in 300; do
            for OTYPE in ctrl p20 m20 lm_ctrl lm_p20 lm_m20; do
                ...
                SCRIPT=hirham_hindcast_g${GRID}m_${RUNE}.sh
