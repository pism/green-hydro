...
ncap2 -O -s "thk=usurf-topg; where(LandMask!=2) thk=0; thk_shelf=(1/((1028./910)-1)+1)*usurf; where(LandMask==0 && thk_shelf>300) thk=thk_shelf; where(LandMask==0 && (usurf-thk)<topg) topg=usurf-thk-50;" $THK.nc $THK.nc
