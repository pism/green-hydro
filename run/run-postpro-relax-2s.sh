...
if [ -f ${filepre}_1.nc ]; then
    ...
    ncks -O --64 -d x,-220000.,-110000. -d y,-2310000.,-2240000. ex_${filepre}_1.nc ${tl_dir}/${nc_dir}/jak_ex_${filepre}_1.nc
    ncks --64 -v enthalpy,litho_temp,temp_pa,liqfrac,cts,temp,temp_pa,uvel,vvel,wvel,wvel_rel -x ${filepre}_1.nc ${tl_dir}/${nc_dir}/${filepre}_1.nc
...
if [ -f ${filepre}_2.nc ]; then
    ...
    ncks -O --64 -d x,-220000.,-110000. -d y,-2310000.,-2240000. ex_${filepre}_2.nc ${tl_dir}/${nc_dir}/jak_ex_${filepre}_2.nc
    ncks --64 -v enthalpy,litho_temp,temp_pa,liqfrac,cts,temp,temp_pa,uvel,vvel,wvel,wvel_rel -x ${filepre}_2.nc ${tl_dir}/${nc_dir}/${filepre}_2.nc
