...
topg_min_values = [-700]
topg_max_values = [700]
combinations = list(itertools.product(omega_values, alpha_values, k_values, calving_thk_threshold_values, calving_k_values, phi_min_values, phi_max_values, topg_min_values, topg_max_values))
