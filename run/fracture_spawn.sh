...
SSA_N=3.0
SSA_E=0.8
for FSOFT in 0.6 0.8; do
    philow=5.0
    PARAM_TTPHI="${philow},40.0,-700.0,700.0"
    EXPERIMENT=${CLIMATE}_${TYPE}_sia_e_${E}_ppq_${PPQ}_tefo_${TEFO}_ssa_n_${SSA_N}_ssa_e_${SSA_E}_philow_${philow}_fsoft_${FSOFT}_hydro_${HYDRO}
...
SUBMIT=submit_g${GRID}m_${CLIMATE}_${TYPE}_fracture.sh
rm -f $SUBMIT
cat - > $SUBMIT <<EOF
$SHEBANGLINE
