...
if [ -f ${filepre}.nc ]; then
    ...
    basemap-plot.py -v velsurf_mag --inner_titles velsurf_mag --colorbar_label -p medium --singlerow --colormap ~/base/pypismtools/colormaps/Full_saturation_spectrum_CCW_orange.cpt -r $res --coastlines $geotiff -o ${fig_dir}/Greenland_${filepre}_velsurf_mag.pdf ${nc_dir}/${filepre}.nc

    basemap-plot.py -v velbase_mag --inner_titles velsurf_mag --colorbar_label -p medium --singlerow --colormap ~/base/pypismtools/colormaps/Full_saturation_spectrum_CCW_orange.cpt -r $res --coastlines $geotiff -o ${fig_dir}/Greenland_${filepre}_velbase_mag.pdf ${nc_dir}/${filepre}.nc
    ...
    basemap-plot.py -v tau_rel --inner_titles $var -p medium --singlerow -r $res --map_resolution --coastlines $geotiff -o ${fig_dir}/Greenland_${filepre}_tau_rel.pdf ${nc_dir}/${filepre}.nc
...
\parindent0pt
\\begin{document}
\includepdfmerge[nup=2x2,landscape,pagecommand={\thispagestyle{myheadings}\markright{\huge{$title}}}]{${fig_dir}/Greenland_${filepre}_velsurf_mag.pdf,1,${fig_dir}/Greenland_${filepre}_velbase_mag.pdf,1,${fig_dir}/Greenland_${filepre}_tau_rel.pdf,1,${fig_dir}/Greenland_${filepre}_tau_r.pdf,1}
\end{document}
EOLF
