...
#                                for addbwat in "_lnbwat" "" "_addbwat"; do
                                for addbwat in "_bwatfrac0.05"; do
...
\parindent0pt
\\begin{document}
\includepdfmerge[nup=3x2,landscape,pagecommand={\thispagestyle{myheadings}\markright{\huge{$title}}}]{${filepre}_velsurf_mag.pdf,1,${filepre}_velbase_mag.pdf,1,${filepre}_bwat.pdf,1,${filepre}_tillwat.pdf,1,${filepre}_tau_rel.pdf,1,${filepre}_tau_r.pdf,1}
\end{document}
EOF
                                        pdflatex $FILE
                                        rm $FILE
